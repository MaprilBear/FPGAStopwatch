...
set_property PACKAGE_PIN V17 [get_ports {ext[0]}]	
## Sets the switch to use 3.3V logic				
	set_property IOSTANDARD LVCMOS33 [get_ports {ext[0]}]    

## Connects pin V16 (SW1 on the board) to input b in our gate module
set_property PACKAGE_PIN V16 [get_ports {ext[1]}]			
## Sets the switch to use 3.3V logic
	set_property IOSTANDARD LVCMOS33 [get_ports {ext[1]}]    
	
set_property PACKAGE_PIN W16 [get_ports {ext[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ext[2]}]
set_property PACKAGE_PIN W17 [get_ports {ext[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ext[3]}]
set_property PACKAGE_PIN W15 [get_ports {ext[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ext[4]}]
set_property PACKAGE_PIN V15 [get_ports {ext[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ext[5]}]
set_property PACKAGE_PIN W14 [get_ports {ext[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ext[6]}]
set_property PACKAGE_PIN W13 [get_ports {ext[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ext[7]}]
